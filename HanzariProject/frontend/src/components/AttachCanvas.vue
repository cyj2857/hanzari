...
export default {
  ...
  methods: {
    test() {
      let create = this.getCreateSeatList(this.currentSelectedFloor);
   ...
   loadImage(file) {
    ...
    deleteAllBtn() {
      //사본 deleteSeatList
      let deleteSeatList = this.getDeleteSeatList(this.currentSelectedFloor);
