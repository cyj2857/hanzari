  ...
  methods: {
    ...
    on_mouse_move (event) {
      if(this.isEnable) {
        ...
        if(this.diffpos > -(width - this.range) && this.diffpos < (width - this.range)) {
          document.getElementById("d1").style.width = width - this.diffpos + "px"
				  document.getElementById("d2").style.width = width - 20 + this.diffpos + "px"
        }
      }
    }
  },
